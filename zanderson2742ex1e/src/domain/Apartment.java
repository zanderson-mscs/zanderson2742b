...
//
    ...
    public Invoice removeInvoice(Invoice invoice) {
        ...
        int index = this.invoices.indexOf(invoice);
        removedInvoice = this.invoices.get(index).copy();
        this.invoices.remove(removedInvoice);
    ...
    public Invoice getInvoice(int index) {
        Invoice invoice = new Invoice(getInvoice(index));
        for (Invoice item : this.invoices){
           // Invoice.copy();
        }
        return invoice;
    }
